...
The effect of the association was significant (`r format_or(or_o)`).
...
tab_inf_22_un %>%
  as_kable(
    align = "lccc",
    caption = "**Table 3** Cross tabulation of dichotomized responses, overall and by sex of survey respondents, disregarding the survey weights."
  )
```
...
The effect sizes for males and females were similar to each other (`r format_or(or_m)` and females: `r format_or(or_f)`).
