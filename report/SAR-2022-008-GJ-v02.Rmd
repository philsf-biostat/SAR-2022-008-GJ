...
Survey designs can account for multiple sampling of certain individuals (which can occur in randomized sampling designs) and in some cases may also need to oversample minority populations in order to increase precision in the estimates obtained from these groups.
